#### Description: Script to map 2D annotation files from input onto the assembly chromosome according to a particular assembly file.
#### Usage: awk -v scale=<scale> -f list-input-annotations-to-assembly-annotations.awk <assembly> <input-annotation-file>
...
#### Written by: Olga Dudchenko - olga.dudchenko@bcm.edu, version 20180401
